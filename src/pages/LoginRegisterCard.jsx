...
const LoginRegisterCard = ({ onClose, initialMode = 'login' }) => {
  const [currentMode, setCurrentMode] = useState(initialMode); // 'login', 'register', 'forgot'
  ...
  const handleSubmit = (e) => {
    ...
    if (currentMode === 'forgot') {
      // Show success message or handle forgot password logic
  ...
  return (
    <div
      className={`fixed inset-0 flex items-center justify-center z-50 transition-all duration-300 ${fadeIn ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
        } bg-black/50 backdrop-blur-sm`}
      onClick={handleClose}
    >
      <div
        className={`relative w-full max-w-md mx-4 p-8 bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/50 transition-all duration-300 ${fadeIn ? 'translate-y-0' : 'translate-y-8'
          }`}
      ...
      >
        ...
        {currentMode === 'forgot' && (
          <button
            ...
            className="absolute top-4 left-4 w-10 h-10 flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-full transition-all duration-200 group"
        ...
        {currentMode !== 'forgot' && (
          <div className="flex mb-8 bg-gray-100 rounded-2xl p-1">
            <button
              className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all duration-300 ${currentMode === 'login'
            ...
            <button
              className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all duration-300 ${currentMode === 'register'
                  ? 'bg-white text-purple-600 shadow-md transform scale-105'
                  : 'text-gray-600 hover:text-gray-800'
                }`}
        ...
        {currentMode !== 'forgot' && (
          <div className="mt-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center p-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors duration-200"
              >
