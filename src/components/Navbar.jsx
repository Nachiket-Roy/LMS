...
const Navbar = ({ onAuthClick }) => {
  ...
  return (
    <div
      className={`fixed inset-x-0  z-50 h-16  bg-purple-900 shadow-lg transition-all duration-500 ${showNavbar ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10 pointer-events-none'
        }`}
    >
